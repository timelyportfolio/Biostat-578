...
```
<!--looks like ---------- denotes two column for rpres-->
-----------
...
```{r qplot-on-iris-scatter-facet2}
# Points and line
qplot(x=Sepal.Width, y=Sepal.Length, data=iris, geom=c("point","smooth"), color=Species, size=Petal.Width, method="lm", facets= Species~.)
```
